...
- (void)beginMoveTrackerFollowScrollView:(UIScrollView *)scrollView {
    ...
    {
        switch (self.numberViewControllerSelected) {
            case SecondViewControllerSelected:
                 [self moveTrackerWithProgress:0.53 fromIndex:0 toIndex:1 currentOffsetX:220 beginOffsetX:0];
                break;
            case ThirdViewControllerSelected:
                [self moveTrackerWithProgress:0.7 fromIndex:1 toIndex:2 currentOffsetX:710 beginOffsetX:414];
                break;
            default:
                break;
        }
    ...
    NSLog(@"selectedItemIndex:  %ld,fromIdex:  %ld,toIndex:  %ld,progress:%f,currentOffSetx:%f,beginOffSextx:%f",self.selectedItemIndex,fromIndex,toIndex,progress,currentOffSetX,_beginOffsetX);
