...
typedef NS_ENUM(NSInteger, NumberViewControllerSelected) {
    FirstViewControllerSelected = 0,                  // 下划线,默认与item等宽
    SecondViewControllerSelected,        // 下划线,比item要长(长度为item的宽+间距)
    ThirdViewControllerSelected,            // 下划线依恋样式
...
@property(nonatomic,assign)NumberViewControllerSelected numberViewControllerSelected;
...
//@property (nonatomic,strong) ScrollviewFunction *itemScrollView;
